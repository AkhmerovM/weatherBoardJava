    ...
    <div class="col-md-10 col-lg-8 col-xl-6" >
        ...
        <form class="feedback-form" id="feedback-form" action="/feedback" method="post">
            <div class="mb-3">
                ...
                <input class="form-control" required name="name" placeholder="Имя" value="" id="exampleInputName" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail" class="form-label">Почта mail</label>
                <input type="email" required name="email" placeholder="почта" class="form-control" value="" id="exampleInputEmail"
